...
namespace Szwalnia
{
    public partial class NowyNiewykorzystanyMaterialOdpad : Form
    {
        ...
        public NowyNiewykorzystanyMaterialOdpad(SzwalniaEntities db, int idProcesu)
        {
            ...
            lblTekst.Text = "Wprowadzenie nowego niewykorzystanego materiału / odpadu dla procesu produkcyjnego o ID " + proces.ID_Procesu_Produkcyjnego;
        ...
        private void btnZapisz_Click(object sender, EventArgs e)
        {
            ...
            materialProdukcja.ID_Elementy_Proces = Convert.ToInt32(cbxElement.Text);
            materialProdukcja.Odpad= Convert.ToInt32(tbOdpad.Text);
            materialProdukcja.Niezuzyty_material = Convert.ToInt32(tbNiewykorzystanyMaterial.Text);
