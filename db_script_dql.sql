...
AS
SELECT        TOP (100) PERCENT ID_Rozmiar_Polki, Wysokosc, Szerokosc, Glebokosc, 
				CAST(Wysokosc AS NVARCHAR) + ' x ' + CAST(Szerokosc AS NVARCHAR) + ' x ' + CAST(Glebokosc AS NVARCHAR) + ' cm' AS Wymiar
